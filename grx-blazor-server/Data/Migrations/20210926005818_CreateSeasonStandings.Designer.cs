...
namespace grx_blazor_server.Data.Migrations
{
    ...
    [Migration("20210926005818_CreateSeasonStandings")]
    partial class CreateSeasonStandings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PlayerSeason", b =>
                {
                    b.Property<Guid>("PlayersPlayerUid")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("SeasonsSeasonUid")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("PlayersPlayerUid", "SeasonsSeasonUid");

                    b.HasIndex("SeasonsSeasonUid");
            ...
            modelBuilder.Entity("PlayerSeason", b =>
                {
                    b.HasOne("grx_blazor_server.Models.Player", null)
                        .WithMany()
                    ...
                    b.HasOne("grx_blazor_server.Models.Season", null)
                        .WithMany()
                        .HasForeignKey("SeasonsSeasonUid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("grx_blazor_server.Models.Game", b =>
                {
                    b.HasOne("grx_blazor_server.Models.Season", "Season")
                        .WithMany("Games")
            ...
            modelBuilder.Entity("grx_blazor_server.Models.GameResult", b =>
                {
                    b.HasOne("grx_blazor_server.Models.Game", "Game")
            ...
            modelBuilder.Entity("grx_blazor_server.Models.LeagueNight", b =>
                {
                    b.HasOne("grx_blazor_server.Models.League", "League")
